...
- `alt/option arrow` Move cursor by word
- letter[TAB]
...
Let's turn to a [lab](https://git.generalassemb.ly/sei-embers/kitchen-organizer)
...
- [Command Line Fu](https://git.generalassemb.ly/sei-embers/command-line-fu)
- [Kitchen Organizer](https://git.generalassemb.ly/sei-embers/kitchen-organizer)
